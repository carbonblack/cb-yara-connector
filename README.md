...
Download the latest RPM from the github releases page, [here](https://github.com/carbonblack/cb-yara-connector/releases/download/untagged-95171adc2cb55d3f96c5/python-cb-yara-connector-2.1-0.x86_64.rpm).
